      ...
      <div className="auth-card animate-fade-in">
        <div className="auth-logo">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">Where Connectivity Comes Alive</p>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          ...
          <Link to="/register" className="text-cyan-400 hover:text-cyan-300 hover:underline" data-testid="register-link">
            Create one
          </Link>
        </p>
      </div>
